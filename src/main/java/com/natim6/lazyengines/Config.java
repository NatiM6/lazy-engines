...
public class Config {
    ...
    public static final ForgeConfigSpec.IntValue SEETHING_BURNER = BUILDER
            ...
            .defineInRange("seething_burner_heat", 4, 2, Integer.MAX_VALUE);
